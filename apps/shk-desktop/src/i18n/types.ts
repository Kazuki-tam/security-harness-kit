...
export type Messages = {
  ...
  mask: {
    ...
    pseudonymize: {
      ...
      customLabelInvalid: string;
      customLabelReserved: string;
      sheetLabel: string;
      sheetHint: string;
      textModeTitle: string;
      textModeHint: string;
      textModeOfficeHint: string;
      advancedTitle: string;
      advancedHint: string;
      restoreMapLabel: string;
      restoreMapHint: string;
      restoreMapPath: string;
      restoreMapUnavailableText: string;
      ...
      keyDialogBody: string;
      keyDialogConfirm: string;
      keyUnavailable: string;
      summaryTitle: string;
      summaryRows: string;
      summaryReplaced: string;
      summaryReplacedItem: string;
      summaryNoneReplaced: string;
      summaryUnparsed: string;
      summaryLeftovers: string;
      summaryFiles: string;
      fileOutput: string;
      fileMeta: string;
      fileMap: string;
