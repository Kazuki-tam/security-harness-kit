...
export const en: Messages = {
  ...
  mask: {
    ...
    mode: {
      ...
      redact: "Redact",
      redactHint: "Replace sensitive text with [REDACTED]",
    ...
    pseudonymize: {
      ...
      policySelectRequired: "Choose a project…",
      requiresProjectTitle: "Choose a project to pseudonymize",
      requiresProject:
      ...
      previewReady: "Table ready: {{count}} columns, {{rows}} rows. Choose columns in the preview.",
      viewPreview: "Choose columns in preview",
      ...
      noPreviewRows: "No data rows to preview. Check the header setting.",
      openTableSelection: "Preview table and choose columns",
      ...
      kinds: {
        ...
        phone: "Phone number",
        name: "Person's name",
        custom: "Other (give it a label)",
        none: "Leave as is",
      },
      kindCustomDisplay: "Other ({{label}})",
      ...
      customLabelHint:
        "Lowercase letters, numbers, and _ only (example: member_id). It becomes the start of each code.",
      customLabelInvalid:
        "Start with a lowercase letter and use only lowercase letters, numbers, and _ (up to 33 characters).",
      customLabelReserved: "This label is reserved. Choose another.",
      sheetLabel: "Sheet",
      sheetHint: "Only this sheet is pseudonymized.",
      ...
      run: "Pseudonymize and save…",
      runText: "Pseudonymize",
      running: "Pseudonymizing…",
      chooseOutput: "Save pseudonymized file",
      keyDialogTitle: "Create a pseudonymize key for {{project}}?",
      keyDialogBody:
        "This project has no pseudonymize key yet. A new key will be saved in your computer's credential store ({{backend}}) and used to keep codes consistent. The shk command line uses the same key. It is never written into the project folder.",
      keyDialogConfirm: "Create key and continue",
      keyUnavailable: "The credential store is not available: {{reason}}",
      summaryTitle: "Pseudonymized",
      summaryRows: "{{count}} rows processed",
      summaryReplaced: "Replaced",
      summaryReplacedItem: "{{kind}}: {{count}}",
      summaryNoneReplaced: "Nothing was replaced.",
      summaryUnparsed:
        "{{count}} value(s) did not look like the chosen kind and were replaced with [UNPARSED]. They cannot be restored.",
      summaryLeftovers:
        "Possible sensitive values remain in the output ({{rules}}). Review it before sharing.",
      summaryFiles: "Files written",
      fileOutput: "Pseudonymized file",
      fileMeta: "Summary (contains no personal data)",
      fileMap: "Restore map (keep private)",
      copyPath: "Copy path",
      pathCopied: "Path copied",
      outputTitle: "Pseudonymized text",
      outputHint: "Review the result, then copy it into your AI tool.",
      statusDone: "Done.",
      startOver: "Start over",
      failed: "Pseudonymize failed",
    },
  },
  cloneRepository: {
