...
```text
https://github.com/Kazuki-tam/security-harness-kit/releases/tag/desktop-v0.6.3
```

Verify checksums when available:

```bash
curl -LO https://github.com/Kazuki-tam/security-harness-kit/releases/download/desktop-v0.6.3/shk-desktop.sha256sum
