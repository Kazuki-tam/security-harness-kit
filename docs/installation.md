...
```text
https://github.com/Kazuki-tam/security-harness-kit/releases/tag/desktop-unsigned-v0.5.2
```

Verify checksums when available:

```bash
curl -LO https://github.com/Kazuki-tam/security-harness-kit/releases/download/desktop-unsigned-v0.5.2/shk-desktop.sha256sum
