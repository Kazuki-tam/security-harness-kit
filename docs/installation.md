...
on GitHub Releases. Starting with `desktop-v0.6.0`, <!-- shk-version-pin -->
macOS builds are Developer ID signed, notarized, and stapled. Windows installers are currently **not**
...
Installers from `desktop-v0.6.0` onward <!-- shk-version-pin -->
...
Before `desktop-v0.6.0`, <!-- shk-version-pin -->
builds were published unsigned from
