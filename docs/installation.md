...
```text
https://github.com/Kazuki-tam/security-harness-kit/releases/tag/desktop-v0.6.4
```

Verify checksums when available:

```bash
curl -LO https://github.com/Kazuki-tam/security-harness-kit/releases/download/desktop-v0.6.4/shk-desktop.sha256sum
